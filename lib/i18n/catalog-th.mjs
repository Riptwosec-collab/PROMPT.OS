...
const CATALOG_THAI_TEXT = Object.freeze({
  ...
  Stop: 'หยุด',
  Retry: 'ลองใหม่',
  'Run Again': 'รันอีกครั้ง',
  'Edit Prompt': 'แก้ไขพรอมต์',
  Copied: 'คัดลอกแล้ว',
  'Jump to latest': 'ไปยังล่าสุด',
  'Save Result': 'บันทึกผลลัพธ์',
  Provider: 'ผู้ให้บริการ',
  Model: 'โมเดล',
  Latency: 'เวลาแฝง',
  'Input tokens': 'โทเคนขาเข้า',
  'Output tokens': 'โทเคนขาออก',
  'Total tokens': 'โทเคนทั้งหมด',
  'Response ID': 'รหัสการตอบกลับ',
  'Run status': 'สถานะการรัน',
  'Waiting for the first response chunk…': 'กำลังรอข้อมูลตอบกลับชุดแรก…',
  'Run the prompt to see streamed output here.': 'รันพรอมต์เพื่อดูผลลัพธ์แบบสตรีมที่นี่',
  'Active run controls': 'ตัวควบคุมการรันที่กำลังทำงาน',
  Improve: 'ปรับปรุง',
  Copy: 'คัดลอก',
  Favorite: 'รายการโปรด',
  ...
  Pin: 'ปักหมุด',
  Unpin: 'เลิกปักหมุด',
  'Add to pack': 'เพิ่มไปยังชุดพรอมต์',
  'Quick actions': 'การทำงานด่วน',
