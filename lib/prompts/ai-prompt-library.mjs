...
import { CORE_QUALITY_METADATA } from './catalog/quality-v2/metadata-core.mjs';
import { enrichBuiltInPrompt } from './catalog/quality-v2/index.mjs';
...
const CORE_PROMPTS = PROMPT_SPECS.map((spec) => enrichBuiltInPrompt(buildPromptFromSpec(spec), CORE_QUALITY_METADATA));
