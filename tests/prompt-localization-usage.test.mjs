...
test('the 50 researched prompts preserve their source-pack sample input separately from the usage guide slot', () => {
  const researched = AI_PROMPT_LIBRARY.slice(30, 80);
