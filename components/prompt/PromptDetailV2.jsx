...
export default function PromptDetailV2({
  ...
  return (
    <section className="h-full overflow-auto p-3 md:p-5" data-prompt-detail-v2>
      <div className="mx-auto max-w-[1500px]">
        ...
        <div className="grid gap-4 lg:grid-cols-[0.85fr_1.15fr_1fr]">
          <aside data-region="info" className="v5-glass order-1 rounded-2xl border border-white/10 p-4 lg:sticky lg:top-3 lg:self-start">
            ...
            <h1 className="mt-2 text-xl font-semibold text-white">{prompt.displayTitleTh || prompt.displayTitle || prompt.title || prompt.name}</h1>
